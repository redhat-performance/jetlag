...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-1d-1000p-1c-gohttp" -n 1 -d 1 -p 1000 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "2n-1d-500p-1c-gohttp" -n 2 -d 1 -p 500 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "4n-1d-250p-1c-gohttp" -n 4 -d 1 -p 250 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "10n-1d-100p-1c-gohttp" -n 10 -d 1 -p 100 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "20n-1d-50p-1c-gohttp" -n 20 -d 1 -p 50 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "50n-1d-20p-1c-gohttp" -n 50 -d 1 -p 20 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "100n-1d-10p-1c-gohttp" -n 100 -d 1 -p 10 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "250n-1d-4p-1c-gohttp" -n 250 -d 1 -p 4 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "500n-1d-2p-1c-gohttp" -n 500 -d 1 -p 2 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1000n-1d-1p-1c-gohttp" -n 1000 -d 1 -p 1 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-1d-1000p-1c-pause" -n 1 -d 1 -p 1000 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "2n-1d-500p-1c-pause" -n 2 -d 1 -p 500 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "4n-1d-250p-1c-pause" -n 4 -d 1 -p 250 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "10n-1d-100p-1c-pause" -n 10 -d 1 -p 100 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "20n-1d-50p-1c-pause" -n 20 -d 1 -p 50 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "50n-1d-20p-1c-pause" -n 50 -d 1 -p 20 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "100n-1d-10p-1c-pause" -n 100 -d 1 -p 10 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "250n-1d-4p-1c-pause" -n 250 -d 1 -p 4 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "500n-1d-2p-1c-pause" -n 500 -d 1 -p 2 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1000n-1d-1p-1c-pause" -n 1000 -d 1 -p 1 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-1d-1000p-1c-hello" -n 1 -d 1 -p 1000 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "2n-1d-500p-1c-hello" -n 2 -d 1 -p 500 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "4n-1d-250p-1c-hello" -n 4 -d 1 -p 250 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "10n-1d-100p-1c-hello" -n 10 -d 1 -p 100 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "20n-1d-50p-1c-hello" -n 20 -d 1 -p 50 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "50n-1d-20p-1c-hello" -n 50 -d 1 -p 20 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "100n-1d-10p-1c-hello" -n 100 -d 1 -p 10 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "250n-1d-4p-1c-hello" -n 250 -d 1 -p 4 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "500n-1d-2p-1c-hello" -n 500 -d 1 -p 2 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1000n-1d-1p-1c-hello" -n 1000 -d 1 -p 1 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
