...
measurement="-D 180"
csvfile="--csv-file tc1-$(date -u +%Y%m%d-%H%M%S).csv"
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "1c-0s-no_probes" -n 1 -d 1 -p 1 -c 1 --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "10c-0s-no_probes" -n 1 -d 1 -p 1 -c 10 --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "40c-0s-no_probes" -n 1 -d 1 -p 1 -c 40 --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "80c-0s-no_probes" -n 1 -d 1 -p 1 -c 80 --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "160c-0s-no_probes" -n 1 -d 1 -p 1 -c 160 --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "1c-1s-no_probes" -n 1 -d 1 -p 1 -c 1 -l --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "10c-1s-no_probes" -n 1 -d 1 -p 1 -c 10 -l --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "40c-1s-no_probes" -n 1 -d 1 -p 1 -c 40 -l --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "80c-1s-no_probes" -n 1 -d 1 -p 1 -c 80 -l --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "160c-1s-no_probes" -n 1 -d 1 -p 1 -c 160 -l --no-probes ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "1c-1s-probes" -n 1 -d 1 -p 1 -c 1 -l ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "10c-1s-probes" -n 1 -d 1 -p 1 -c 10 -l ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "40c-1s-probes" -n 1 -d 1 -p 1 -c 40 -l ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "80c-1s-probes" -n 1 -d 1 -p 1 -c 80 -l ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} ${csvfile} --csv-title "160c-1s-probes" -n 1 -d 1 -p 1 -c 160 -l ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
