...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1cm-0s" -n 1 -d 1 -p 1 -c 1 -l -m 1 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "10cm-0s" -n 1 -d 1 -p 1 -c 1 -l -m 10 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "40cm-0s" -n 1 -d 1 -p 1 -c 1 -l -m 40 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "80cm-0s" -n 1 -d 1 -p 1 -c 1 -l -m 80 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "160cm-0s" -n 1 -d 1 -p 1 -c 1 -l -m 160 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "0cm-1s" -n 1 -d 1 -p 1 -c 1 -l -m 0 --secrets 1  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "0cm-10s" -n 1 -d 1 -p 1 -c 1 -l -m 0 --secrets 10  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "0cm-40s" -n 1 -d 1 -p 1 -c 1 -l -m 0 --secrets 40  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "0cm-80s" -n 1 -d 1 -p 1 -c 1 -l -m 0 --secrets 80  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "0cm-160s" -n 1 -d 1 -p 1 -c 1 -l -m 0 --secrets 160  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1cm-1s" -n 1 -d 1 -p 1 -c 1 -l -m 1 --secrets 1  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "10cm-10s" -n 1 -d 1 -p 1 -c 1 -l -m 10 --secrets 10  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "40cm-40s" -n 1 -d 1 -p 1 -c 1 -l -m 40 --secrets 40  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "80cm-80s" -n 1 -d 1 -p 1 -c 1 -l -m 80 --secrets 80  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "160cm-160s" -n 1 -d 1 -p 1 -c 1 -l -m 160 --secrets 160  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
