...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-2d-500p-1c-gohttp" -n 1 -d 2 -p 500 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-4d-250p-1c-gohttp" -n 1 -d 4 -p 250 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-10d-100p-1c-gohttp" -n 1 -d 10 -p 100 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-20d-50p-1c-gohttp" -n 1 -d 20 -p 50 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-50d-20p-1c-gohttp" -n 1 -d 50 -p 20 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-100d-10p-1c-gohttp" -n 1 -d 100 -p 10 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-250d-4p-1c-gohttp" -n 1 -d 250 -p 4 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-500d-2p-1c-gohttp" -n 1 -d 500 -p 2 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-1000d-1p-1c-gohttp" -n 1 -d 1000 -p 1 -c 1 -l -m 0 --secrets 0  ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-2d-500p-1c-pause" -n 1 -d 2 -p 500 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-4d-250p-1c-pause" -n 1 -d 4 -p 250 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-10d-100p-1c-pause" -n 1 -d 10 -p 100 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-20d-50p-1c-pause" -n 1 -d 20 -p 50 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-50d-20p-1c-pause" -n 1 -d 50 -p 20 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-100d-10p-1c-pause" -n 1 -d 100 -p 10 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-250d-4p-1c-pause" -n 1 -d 250 -p 4 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-500d-2p-1c-pause" -n 1 -d 500 -p 2 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-1000d-1p-1c-pause" -n 1 -d 1000 -p 1 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-2d-500p-1c-hello" -n 1 -d 2 -p 500 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-4d-250p-1c-hello" -n 1 -d 4 -p 250 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-10d-100p-1c-hello" -n 1 -d 10 -p 100 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-20d-50p-1c-hello" -n 1 -d 20 -p 50 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-50d-20p-1c-hello" -n 1 -d 50 -p 20 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-100d-10p-1c-hello" -n 1 -d 100 -p 10 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-250d-4p-1c-hello" -n 1 -d 250 -p 4 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-500d-2p-1c-hello" -n 1 -d 500 -p 2 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
...
../../workload/jetlag-workload.py ${dryrun} --csv-title "1n-1000d-1p-1c-hello" -n 1 -d 1000 -p 1 -c 1 -l -m 0 --secrets 0 ${image} ${gohttp_env_vars} ${measurement} ${INDEX_ARGS} &> ${logfile}
