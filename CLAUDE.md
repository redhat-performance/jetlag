...
- **[docs/bastion-minio.md](docs/bastion-minio.md)**: RustFS object storage setup and usage covering:
  - Variables and configuration options
  - Deploying RustFS via `setup-bastion.yml` or standalone `bastion-minio.yml`
  - Accessing the S3 API (port 9000) and web console (port 9001)
  - Cleaning RustFS data between cluster deployments with `bastion-minio-clean.yml`
