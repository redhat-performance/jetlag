...
If everything goes well you should have a cluster in about 60-70 minutes. You can interact with the cluster from the bastion. If you installed a SNO instead, look for the kubeconfig file under `/root/sno/...`
