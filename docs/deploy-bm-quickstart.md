...
Change `ocp_release_image` to the desired image if the default (4.8.0) is not the desired version.
...
ocp_release_image: quay.io/openshift-release-dev/ocp-release:4.8.0-x86_64
