...
Change `ocp_release_image` to the required image if the default (4.9.21) is not the desired version.
...
ocp_release_image: quay.io/openshift-release-dev/ocp-release:4.9.21-x86_64
