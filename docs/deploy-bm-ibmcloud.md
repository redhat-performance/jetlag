...
Change `ocp_release_image` to the required image if the default (4.10.2) is not the desired version.
...
ocp_release_image: quay.io/openshift-release-dev/ocp-release:4.10.2-x86_64
