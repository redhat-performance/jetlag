...
Change `ocp_release_image` to the required image if the default (4.10.7) is not the desired version.
...
ocp_release_image: quay.io/openshift-release-dev/ocp-release:4.10.7-x86_64
